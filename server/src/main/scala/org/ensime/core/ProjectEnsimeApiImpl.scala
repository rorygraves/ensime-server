...
trait ProjectEnsimeApiImpl extends EnsimeApi { self: Project =>
  ...
  override def rpcDebugContinue(threadId: ThreadId): Boolean = {
  ...
  override def rpcDebugNext(threadId: ThreadId): Boolean = {
    callRPC[Boolean](acquireDebugger, DebugNextReq(threadId))
  }

  override def rpcDebugStep(threadId: ThreadId): Boolean = {
    callRPC[Boolean](acquireDebugger, DebugStepReq(threadId))
  }

  override def rpcDebugStepOut(threadId: ThreadId): Boolean = {
    callRPC[Boolean](acquireDebugger, DebugStepOutReq(threadId))
  }

  override def rpcDebugLocateName(threadId: ThreadId, name: String): Option[DebugLocation] = {
  ...
  override def rpcDebugToString(threadId: ThreadId, loc: DebugLocation): Option[String] = {
  ...
  override def rpcDebugBacktrace(threadId: ThreadId, index: Int, count: Int): DebugBacktrace = {
